        ...
        <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center ">
            <div className="bg-white rounded-lg xl:h-[80vh] w-[60%] flex gap-6 flex-wrap justify-between items-center p-14 pt-6">
                <div>
                    ...
                    <div className="border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center items-center outline-one mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:border-red-300 hover:bg">
                        {isLoading ? (
                            <p>Uploading...</p>
                        ) : (
                            <div>
